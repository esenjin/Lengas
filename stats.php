...
<body class="stats-page with-sidebar">
    ...
    <!-- Modale de fiche « Personnalité » (auteur, éditeur, autre
         ...
         modale de détail série ci-dessous (assets/js/public.js,
         openPersonalityModalByName()), jamais une navigation vers
         personnalites.php — reste sur la page courante. Même structure que
         sur personnalites.php (l'annuaire lui-même). -->
