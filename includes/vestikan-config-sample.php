 ...
 * ─────────────────────────────────────────────────────────────────────────────
 *
 *  Le SSO Vestikan est ACTIVÉ uniquement si le fichier includes/vestikan-config.php
 ...
 *      redirect_uri à déclarer = l'URL EXACTE de vestikan-callback.php sur votre
 *      serveur (en HTTPS), par ex. https://mon-domaine.tld/vestikan-callback.php
...
return [
    ...
    'redirect_uri'  => 'https://mon-domaine.tld/vestikan-callback.php',
];
