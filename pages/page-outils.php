...
<body class="with-sidebar tools-page">
    ...
    <main class="page-main">
        ...
        <div class="tools-tabs" role="tablist">
            ...
            <button type="button" class="tools-tab" data-tab="anilist-import">Import Anilist</button>
<?php if (!empty(series_of_type($data, 'anime'))): ?>
            <button type="button" class="tools-tab" data-tab="anilist-recheck">Vérification des animés</button>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <!-- ── Onglet : Import Anilist ──────────────────────────────────────── -->
        <div class="tools-tab-panel" data-tab-panel="anilist-import">
            <div class="tools-section">
        ...
        <div class="tools-tab-panel" data-tab-panel="anilist-recheck">
            <div class="tools-section">
                ...
                <p class="hint">⚠️ Périmètre disjoint de la synchronisation (onglet « Complétude des séries ») : celle-ci tient déjà à jour les épisodes et le statut de diffusion des séries en cours. Cet outil couvre tout le reste, y compris pour les séries dont la diffusion est terminée, en pause ou abandonnée. Le nombre d'épisodes annoncé n'est ici que signalé : la liste des épisodes elle-même se met à jour via la synchronisation.</p>
    ...
    <?php if (!empty(series_of_type($data, 'anime'))): ?>
        ...
        <script src="../assets/js/admin/tools/anilist-recheck.js"></script>
    <?php endif; ?>
